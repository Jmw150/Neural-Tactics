...
That is enough to prove the tactic-registration path works end to end and to
show where Owl-based decision logic slots into the loop.

## Layout

- `src/owl_bridge.ml`: Owl-side helpers, including a tiny neural network demo
- `src/owl_tactic_core.ml`: plugin-side OCaml tactic logic and Owl scoring
